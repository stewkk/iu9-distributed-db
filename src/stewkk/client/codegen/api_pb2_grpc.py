...
class DbStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetMasterNode = channel.unary_unary('/iu9db.Db/GetMasterNode', request_serializer=api__pb2.EmptyRequest.SerializeToString, response_deserializer=api__pb2.GetMasterNodeReply.FromString, _registered_method=True)
...
class DbServicer(object):
    ...
    def GetMasterNode(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
class Db(object):
    ...
    @staticmethod
    def GetMasterNode(request, target, options=(), channel_credentials=None, call_credentials=None, insecure=False, compression=None, wait_for_ready=None, timeout=None, metadata=None):
        return grpc.experimental.unary_unary(request, target, '/iu9db.Db/GetMasterNode', api__pb2.EmptyRequest.SerializeToString, api__pb2.GetMasterNodeReply.FromString, options, channel_credentials, insecure, call_credentials, compression, wait_for_ready, timeout, metadata, _registered_method=True)
