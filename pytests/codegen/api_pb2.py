...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_EMPTYREQUEST']._serialized_start = 87
    _globals['_EMPTYREQUEST']._serialized_end = 101
    _globals['_EMPTYREPLY']._serialized_start = 103
    _globals['_EMPTYREPLY']._serialized_end = 115
    _globals['_GETREPLY']._serialized_start = 117
    _globals['_GETREPLY']._serialized_end = 142
    _globals['_DB']._serialized_start = 145
    _globals['_DB']._serialized_end = 345
